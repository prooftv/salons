      ...
      <Card.Body className="d-flex align-items-center">
        <div className="w-100">
          ...
          <Card.Subtitle className="text-sm text-secondary mb-2" as="p">
            <FontAwesomeIcon icon={faMapMarker} className="text-secondary opacity-4 me-1" />
            {data.location}
          </Card.Subtitle>
          ...
          <p className="card-text d-flex justify-content-between text-gray-800 text-sm">
            ...
            <span className="me-1">
              <FontAwesomeIcon icon={faBed} className="text-primary opacity-4 text-xs me-1" />
              {data.bedrooms}
            </span>
            <span className="me-1">
              <FontAwesomeIcon icon={faBath} className="text-primary opacity-4 text-xs me-1" />
              {data.bathrooms}
            </span>
            <span>
              <FontAwesomeIcon icon={faTag} className="text-primary opacity-4 text-xs me-1" />
              {data.price}
            </span>
          </p>
        </div>
