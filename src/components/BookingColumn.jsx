      ...
      <Card.Body className="p-4">
        ...
        <div className="text-block py-3">
          <ul className="list-unstyled mb-0">
            <li className="mb-3">
              <FontAwesomeIcon icon={faUsers} className="fa-fw text-muted me-2" />3 guests
            </li>
            <li className="mb-0">
              <FontAwesomeIcon icon={faCalendar} className="fa-fw text-muted me-2" />
              {from.month.substring(0, 3)} {from.day}, {from.year}{" "}
              <FontAwesomeIcon icon={faArrowRight} className="fa-fw text-muted mx-3" />
