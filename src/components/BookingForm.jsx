...
import { faCat, faChild, faGlassCheers, faSmokingBan } from "@fortawesome/free-solid-svg-icons"
      ...
      {block.type === "textarea" && (
        <>
          <div className="d-flex">
            ...
            <div className="ms-4">
              <Avatar image="/content/img/avatar/avatar-10.jpg" alt="Jack London" border />
            </div>
          </div>
          <Form.Control
            as="textarea"
