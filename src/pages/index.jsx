...
import data from "@utils/data/index2.json"
import geoJSON from "@utils/data/restaurants-geojson.json"
...
function Home() {
  return (
    <>
          ...
          <Container className="py-6 py-lg-7 text-white overlay-content text-center">
            <Row>
              <Col xl="10" className="mx-auto">
                <h1 className="display-3 fw-bold text-shadow">{data.hero.title}</h1>
      ...
      {data.popularCities && (
        <PopularCities title={data.popularCities.title} subTitle={data.popularCities.subTitle} />
      )}
      {data.discover && (
        <Discover
          className="pt-4 pb-6"
        ...
        <section className="py-6 py-lg-7 position-relative dark-overlay">
          ...
          <Container>
            <div className="overlay-content text-white py-lg-5 text-center">
              <p className="subtitle text-white letter-spacing-4 mb-4">{data.travel.subtitle}</p>
              <h3 className="display-3 fw-bold text-serif text-shadow mb-5">{data.travel.title}</h3>
      ...
      {data.brands && <Brands title={data.brands.title} brands={data.brands.brands} />}
          ...
          <Container>
            <Row>
              <Col lg="6" className="mb-5 mb-lg-0 text-center text-lg-start">
                <p className="subtitle text-secondary">{data.bottomBlock.title}</p>
              ...
              <Col lg="6" className="d-flex align-items-center justify-content-center">
                <div className="text-center">
                  ...
                  <p className="text-muted text-small">{data.bottomBlock.small}</p>
                </div>
              </Col>
            </Row>
          </Container>
